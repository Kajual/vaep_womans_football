...
Overall, pooled source-target training outperforms women-only training, phase context improves probability estimation, and spatial context mainly produces a tactically plausible redistribution of value. The main conclusion is therefore not that more context always improves prediction, but that different context layers affect different aspects of valuation: phase improves probability estimation, while space changes how value is allocated across roles and tactical situations. The P-VAEP improvement over E-VAEP on the conceding head remains positive under match-level bootstrap resampling, whereas the P-VAEP versus PS-VAEP difference is less stable. Overall, pooled source-target training outperforms
women-only training, phase context improves probability  stimation, and spatial context mainly produces a tactically plausible redistribution of value.
